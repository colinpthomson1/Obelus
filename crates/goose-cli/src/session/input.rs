...
/mode <name> - Set the Obelus mode to use ({modes})
...
/plan <message_text> -  Enters 'plan' mode with optional message. Create a plan based on the current messages and asks user if they want to act on it.
                        If the user acts on the plan, Obelus mode is set to 'auto' and returns to normal Obelus mode.
                        To warm up Obelus before using '/plan', we recommend setting '/mode approve' and providing appropriate context.
...
/endplan - Exit plan mode and return to normal Obelus mode.
