...
static TEMPLATE_REGISTRY: &[(&str, &str)] = &[
    (
        "system.md",
        "Main system prompt that defines Obelus's behavior",
    ),
    (
        "compaction.md",
    ...
    (
        "apps_create.md",
        "Prompt for generating new Obelus apps based on the user instructions",
    ),
    (
        "apps_iterate.md",
        "Prompt for updating existing Obelus apps based on feedback",
    ),
    (
        "permission_judge.md",
    ...
    (
        "plan.md",
        "Prompt used when Obelus creates step-by-step plans. CLI only",
    ),
    (
