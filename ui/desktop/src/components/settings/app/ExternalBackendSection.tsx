...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      'Obelus starts a local backend by default. Use this setting to connect to an external ACP-compatible backend.',
  },
  useExternalServer: {
  ...
  serverUrlHelp: {
    ...
    defaultMessage:
      'Enter the HTTP(S) base URL. Obelus checks /status and connects to /acp under this base.',
  },
  secretKey: {
  ...
  restartNote: {
    ...
    defaultMessage: 'Changes apply to new windows. Restart Obelus to update windows already open.',
  },
  urlProtocolError: {
