...
const i18n = defineMessages({
  ...
  promptEditingDescription: {
    ...
    defaultMessage:
      'Customize the prompts that guide Obelus in different contexts. These prompts use Jinja2 templates; changing template variables incorrectly can break the corresponding workflow.',
  },
  resetAll: {
