...
const i18n = defineMessages({
  ...
  importNostrDesc: {
    ...
    defaultMessage: 'Paste an Obelus Nostr share link to fetch, decrypt, and import the session.',
  },
  importNostrPlaceholder: {
    id: 'sessions.importNostr.placeholder',
    defaultMessage: 'obelus://sessions/nostr?nevent=...&key=...',
  },
  importing: { id: 'sessions.importing', defaultMessage: 'Importing...' },
  chatHistoryDesc: {
    id: 'sessions.chatHistoryDesc',
    defaultMessage: 'View and search your past Obelus conversations. {shortcut} to search.',
  },
