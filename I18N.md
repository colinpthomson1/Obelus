# Internationalization (i18n) — Obelus Desktop

This document describes the i18n infrastructure for Obelus Desktop
(`ui/desktop/`). The `GOOSE_LOCALE` name remains a compatibility interface.
